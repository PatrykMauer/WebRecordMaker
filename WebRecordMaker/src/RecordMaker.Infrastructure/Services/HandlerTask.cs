...
namespace RecordMaker.Infrastructure.Services
{
    public class HandlerTask : IHandlerTask
    {
        ...
        private bool _propagateException;
        private Func<Exception, Task> _onError;
        private bool _executeOnError;
        private Func<RecordMakerException, Task> _onCustomError;
        ...
        public IHandlerTask OnCustomError(Func<RecordMakerException, Task> onCustomError, bool propagateException = false, bool executeOnError = false)
        {
        ...
        {
            var customException = exception as RecordMakerException;
